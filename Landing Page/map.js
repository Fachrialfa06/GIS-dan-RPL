...
class RoadMonitorMap {
            ...
            if (layer.reportData) {
                ...
                switch (filterType) {
                    case 'damageType':
                        ...
                        break;
                    case 'priority':
                        show = value === 'all' || report.priority === value;
                        break;
                    case 'status':
    ...
    showReportDetails(report) {
        ...
        document.getElementById('damageType').textContent = report.type.charAt(0).toUpperCase() + report.type.slice(1);
        document.getElementById('reportPriority').textContent = report.priority.charAt(0).toUpperCase() + report.priority.slice(1);
